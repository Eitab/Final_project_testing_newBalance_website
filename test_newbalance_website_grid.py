...
def driver():
    ...
    #selenium grid
    driver = webdriver.Remote("http://localhost:4444", dc[2])
    # driver=webdriver.Remote("http://localhost:4444/wd/hub",desired_capabilities=dc)
    yield driver
    driver.close()
...
def test_registeration(driver):
    ...
    driver.find_element(By.CSS_SELECTOR, "#registration-form-email").send_keys("rihon72224@runqx.com")
