...
def test_search_product(driver):
    ...
    driver.find_element(By.ID,"21000").click() #Accessories & Gear
    driver.find_element(By.ID,"213510").click() # hat catagory
...
def test_buy_product(driver):
    ...
    time.sleep(3)
    driver.find_element(By.CSS_SELECTOR, ".minicart-link").click()  # click on cart
    time.sleep(3)
...
def test_add_to_wishlost(driver):
    ...
    time.sleep(3)
    wishlist_err=driver.find_element(By.CSS_SELECTOR,".login-heading").text
